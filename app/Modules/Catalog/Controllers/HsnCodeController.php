...
class HsnCodeController extends Controller implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:hsncode-view', only: ['index', 'show']),
            new Middleware('permission:hsncode-create', only: ['store']),
            new Middleware('permission:hsncode-edit', only: ['update']),
