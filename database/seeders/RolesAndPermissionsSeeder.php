...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    private const array ROLE_PERMISSIONS = [
        ...
        'Team Leader' => [
            ...
            'village-import',
            'village-export',
            // Customers — all Agent permissions + view_all (critical for search)
            'view_all_customer',
            'customer-view',
            'customer-create',
            'customer-edit',
            ...
            'user-report',
            'audit-log-view',
            // Call Tagging — allow closing profile without tagging
            'skip-call-log',
            // Chat
            'chat-view',
            'chat-create',
