(function(){System.register(["./main-legacy-DuP-0np_.js","./main-legacy-DO4s7cng.js"],function(n,c){"use strict";var l,o,i;return{setters:[function(e){l=e.m,o=e.c},function(e){}],execute:function(){n("elementsData",i=[{id:"buttons",title:"Buttons",category:"components",icon:"bi bi-square",description:"Bootstrap button styles, sizes, and states",examples:12,url:"/elements-buttons.html",preview:`
        ...
        `}]),document.addEventListener("alpine:init",()=>{l.data("elementsComponent",()=>({components:i,filteredComponents:i,viewMode:"grid",searchQuery:"",categoryFilter:"",init(){this.filteredComponents=this.components},filterComponents(){let e=this.components;if(this.searchQuery){const t=this.searchQuery.toLowerCase();e=e.filter(a=>a.title.toLowerCase().includes(t)||a.description.toLowerCase().includes(t)||a.category.toLowerCase().includes(t))}this.categoryFilter&&(e=e.filter(t=>t.category===this.categoryFilter)),this.filteredComponents=e},toggleView(){this.viewMode=this.viewMode==="grid"?"list":"grid",localStorage.setItem("elements-view-mode",this.viewMode)},navigateToComponent(e){window.location.href=e.url},showAllComponents(){this.searchQuery="",this.categoryFilter="",this.filteredComponents=this.components},clearFilters(){this.searchQuery="",this.categoryFilter="",this.filterComponents()},getComponentCount(e){return this.components.filter(t=>t.category===e).length}})),l.data("searchComponent",o({getResults(e){const t=e.toLowerCase(),a=i.filter(s=>s.title.toLowerCase().includes(t)||s.description.toLowerCase().includes(t)).map(s=>({title:s.title,url:s.url,type:"element"})),r=[{title:"Dashboard",url:"/",type:"page"},{title:"Analytics",url:"/analytics",type:"page"},{title:"Users",url:"/users",type:"page"},{title:"Elements",url:"/elements",type:"page"}].filter(s=>s.title.toLowerCase().includes(t));return[...a,...r].slice(0,8)}}))}),document.addEventListener("DOMContentLoaded",()=>{[...document.querySelectorAll('[data-bs-toggle="tooltip"]')].forEach(t=>new bootstrap.Tooltip(t))})}}})})();
