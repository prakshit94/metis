        ...
        .then((data) => {
          ...
          if (data.stats) {
            this.stats = {
              ...
              unfulfillable: data.stats.unfulfillable,
              unfulfillable_amount: data.stats.unfulfillable_amount,
              ...
              delivery_attempted: data.stats.delivery_attempted,
              delivery_attempted_amount: data.stats.delivery_attempted_amount,
    ...
    async handleImportDeliverSelect(event) {
      ...
      try {
        ...
        if (data.preview) {
          ...
          showToast(data.error || data.message || (data.errors && data.errors.file ? data.errors.file[0] : null) || 'Error occurred.', 'danger');
        }
      } catch (err) {
