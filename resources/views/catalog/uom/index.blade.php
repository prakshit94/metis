...
@section('title', 'Units of Measure Management')
@section('page', 'catalog-uom')
...
<div class="uom-management" x-data="uomTable" x-cloak>
                    ...
                    <tbody>
                        ...
                        <template x-for="item in paginatedItems" :key="item.id">
                            <tr>
                                ...
                                <td>
                                    <div class="fw-medium text-body" x-text="item.name || item.code"></div>
    ...
    <!-- Form Modal -->
    <div class="modal fade" id="uomModal">
