                                    ...
                                    <td>
                                        ...
                                        <template x-if="!row.is_valid">
                                            <span class="text-danger fw-medium">
                                                ...
                                                <span x-text="row.error || (row.current_status === 'Not Found' ? 'Order not found' : (currentBulkImportType === 'deliver' ? 'Must be Dispatched' : 'Must be Delivered or Dispatched'))"></span>
                                            </span>
                                        </template>
                                    </td>
                                </tr>
