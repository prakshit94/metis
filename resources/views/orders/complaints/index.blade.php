                    ...
                    <div class="row g-0 h-100 pvm-layout">
                        ...
                        <div class="col-lg-6 d-flex flex-column border-end bg-body-tertiary h-100 pvm-left">
                            <div class="p-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex flex-column gap-3">
                                            <template x-for="c in selectedOrderDetails.existing_complaints" :key="c.id">
                                                <div class="card border-start border-4 border-secondary shadow-sm rounded-4 bg-warning bg-opacity-10 border border-warning border-opacity-25">
                                ...
                                <div class="card border-start border-4 border-primary shadow-sm rounded-4 mb-4">
                                    <div class="card-body p-3">
                                                            ...
                                                            <div class="position-relative mb-3">
                                                                <template x-if="item._type === 'reply'">
                                                                    <div>
                                                                        ...
                                                                        <div class="card border-start border-4 border-warning shadow-sm rounded-3 bg-primary bg-opacity-10 ms-1">
                        ...
                        <div class="col-lg-6 h-100 bg-body pvm-right border-start">
                            ...
                            <template x-if="selectedOrderDetails">
                                <div class="p-4">
                                    ...
                                    <!-- Customer Info -->
                                    <div class="card border-start border-4 border-info shadow-sm rounded-4 mb-3 bg-body-tertiary">
                                        <div class="card-body p-3">
                                    ...
                                    <!-- Order Items -->
                                    <div class="card border-start border-4 border-danger shadow-sm rounded-4 mb-3 overflow-hidden">
                                    ...
                                    <template x-if="selectedOrderDetails.statusLogs && selectedOrderDetails.statusLogs.length > 0">
                                        <div class="card border-start border-4 border-secondary shadow-sm rounded-4 mb-3">
                                    ...
                                    <template x-if="selectedOrderDetails.original && (selectedOrderDetails.original.order_returns && selectedOrderDetails.original.order_returns.length > 0 || selectedOrderDetails.original.orderReturns && selectedOrderDetails.original.orderReturns.length > 0)">
                                        <div class="card border-start border-4 border-primary shadow-sm rounded-4 bg-danger bg-opacity-10 border border-danger border-opacity-25 p-3 mb-3">
