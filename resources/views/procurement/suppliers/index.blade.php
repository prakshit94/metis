...
<div class="container-fluid p-0" x-data="suppliersTable()">
    ...
    <div class="row g-3 g-lg-4 mb-4">
        <div class="col-12 col-sm-6 col-xl-4">
            <div class="card h-100 border-start border-4 border-primary shadow-sm rounded-4 overflow-hidden position-relative">
        ...
        <div class="col-12 col-sm-6 col-xl-4">
            <div class="card h-100 border-start border-4 border-success shadow-sm rounded-4 overflow-hidden position-relative">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
        ...
        <div class="col-12 col-sm-6 col-xl-4">
            <div class="card h-100 border-start border-4 border-warning shadow-sm rounded-4 overflow-hidden position-relative">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center justify-content-between mb-3">
    ...
    <!-- Data Table Card -->
    <div class="card border-start border-4 border-info shadow-sm rounded-4 mb-4">
                    ...
                    <form id="supplierForm" @submit.prevent="submitForm" x-show="!isViewMode">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="card border-start border-4 border-warning shadow-sm mb-3 bg-body-tertiary">
                                ...
                                <div class="card border-start border-4 border-info shadow-sm mb-3 bg-body-tertiary" style="z-index: 10;">
                                    <div class="card-body p-3">
                                        <div class="d-flex align-items-center mb-3 pb-2 border-bottom">
