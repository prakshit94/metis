...
<div class="card-header bg-transparent border-bottom-0 pt-4 pb-0 px-4">
            ...
            <div class="card-body p-4 d-flex flex-column justify-content-center align-items-center text-center">
                <div class="position-relative d-flex justify-content-center align-items-center mb-3" style="width: 150px; height: 150px;">
                    <svg viewBox="0 0 36 36" class="circular-chart text-success" style="width: 100%; height: 100%;">
                        ...
                        <path class="circle"
                        stroke-dasharray="{{ $fulfillment['fulfillment_rate'] }}, 100"
                        d="M18 2.0845
                            a 15.9155 15.9155 0 0 1 0 31.831
                            a 15.9155 15.9155 0 0 1 0 -31.831"
    ...
    <div class="col-lg-6">
        <div class="card h-100 bg-primary bg-opacity-10 text-primary-emphasis mb-4">
<div class="card-header bg-transparent border-bottom-0 pt-4 pb-0 px-4">
            ...
            <div class="card-body p-4 d-flex flex-column justify-content-center align-items-start">
                <h2 class="display-5 fw-bold mb-3">₹{{ number_format($inventoryValue, 2) }}</h2>
                ...
                <div class="mt-3 pt-3 border-top border-primary border-opacity-25 w-100">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge {{ $shrinkageValue > 0 ? 'bg-success' : 'bg-danger' }} bg-opacity-10 border {{ $shrinkageValue > 0 ? 'border-success' : 'border-danger' }} border-opacity-25 {{ $shrinkageValue > 0 ? 'text-success' : 'text-danger' }}">
                            {{ $shrinkageValue > 0 ? '+' : '' }}₹{{ number_format($shrinkageValue, 2) }}
                        </span>
                    </div>
                </div>
                @endif
