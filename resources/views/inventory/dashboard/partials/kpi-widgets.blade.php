<div class="row row-cols-1 row-cols-md-2 row-cols-xl-5 g-4 g-lg-5 mb-4">
    <div class="col">
        <div class="card h-100 border-start border-4 border-primary bg-primary bg-opacity-10 shadow-sm rounded-4 metric-card p-3">
    ...
    <div class="col">
        <div class="card h-100 border-start border-4 border-success bg-warning bg-opacity-10 shadow-sm rounded-4 metric-card p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
    ...
    <div class="col">
        <div class="card h-100 border-start border-4 border-warning bg-danger bg-opacity-10 shadow-sm rounded-4 metric-card p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
    ...
    <div class="col">
        <div class="card h-100 border-start border-4 border-info bg-info bg-opacity-10 shadow-sm rounded-4 metric-card p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
    ...
    <div class="col">
        <div class="card h-100 border-start border-4 border-danger bg-secondary bg-opacity-10 shadow-sm rounded-4 metric-card p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
