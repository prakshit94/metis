...
<div class="shipments-management" x-data="shipmentsTable" x-cloak>
    ...
    <div class="row g-3 mb-4 mb-lg-5">
        ...
        <div class="col-xl-2 col-lg-4 col-sm-6">
            <div class="card metric-card overflow-hidden h-100">
        ...
        <div class="col-xl-2 col-lg-4 col-sm-6">
            <div class="card metric-card overflow-hidden h-100 bg-primary bg-gradient text-white">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
    ...
    <div class="row g-4 mb-4">
        <!-- Service Providers -->
        <div class="col-12">
            <div class="card h-100 overflow-hidden d-flex flex-column mb-4">
