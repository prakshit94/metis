                ...
                <form @submit.prevent="saveItem">
                    ...
                    <div class="modal-body p-4">
                        <div class="mb-3">
                            ...
                            <div class="form-text">Primary identifier for this hsn code.</div>
                        </div>
                        
                        
                        <div class="mb-3">
                            <label class="form-label fw-medium">Description</label>
                            <input type="text" class="form-control" x-model="form.description">
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ubuntu/metis/resources/views/catalog/hsn-codes/index.blade.php ENDPATH**/ ?>