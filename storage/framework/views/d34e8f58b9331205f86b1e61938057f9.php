                ...
                <form @submit.prevent="saveCustomer()">
                    <div class="tab-content" id="customerFormTabsContent">
                        ...
                        <div class="tab-pane fade" id="tab-financial" role="tabpanel">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Credit Limit (Rs )</label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">Outstanding Balance (Rs )</label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ubuntu/metis/resources/views/customers/index.blade.php ENDPATH**/ ?>