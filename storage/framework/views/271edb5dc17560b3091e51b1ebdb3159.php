            ...
            <div class="d-none d-md-flex justify-content-center px-4 flex-grow-1" style="max-width: 600px;">
                <div class="position-relative w-100" x-data="{
                    ...
                    items: [
                        ...
                        { name: 'Warehouse Dashboard', path: '<?php echo e(route('inventory.dashboard')); ?>', icon: 'bi bi-grid-fill', group: 'Main' },
                        ...
                        { name: 'Referral Programs', path: '<?php echo e(route('referrals.programs.index')); ?>', icon: 'bi bi-people-fill', group: 'Sales & Marketing' },
                        ...
                        { name: 'Credit Notes', path: '<?php echo e(route('credit-notes.index')); ?>', icon: 'bi bi-journal-text', group: 'Billing & Payments' },
                        ...
                        { name: 'Purchase Orders', path: '<?php echo e(route('procurement.purchase-orders.index')); ?>', icon: 'bi bi-cart-check-fill', group: 'Procurement' },
                        { name: 'Goods Receipts', path: '<?php echo e(route('procurement.goods-receipts.index')); ?>', icon: 'bi bi-box-arrow-in-down', group: 'Procurement' },
                        ...
                        { name: 'Customer Settings', path: '<?php echo e(route('customer-settings.index')); ?>', icon: 'bi bi-person-gear', group: 'User & Customer Admin' },
                        ...
                        { name: 'Call Tags', path: '<?php echo e(route('call-tags.index')); ?>', icon: 'bi bi-tags-fill', group: 'User & Customer Admin' },
                        ...
                        { name: 'Audit Logs', path: '<?php echo e(route('admin.audit-logs.index')); ?>', icon: 'bi bi-journal-medical', group: 'Utilities & Tools' },
                            ...
                            <div class="tab-pane fade" id="messages-noti-tab" role="tabpanel">
                                <div style="max-height: 300px; overflow-y: auto;" class="custom-scrollbar">
                                    ...
                                    <a class="dropdown-item p-3 border-bottom d-flex align-items-start gap-3 text-wrap transition-all bg-primary bg-opacity-10 position-relative" href="#">
                                        ...
                                        <img src="<?php echo e(asset('assets/images/users/avatar-3.jpg')); ?>" class="rounded-circle flex-shrink-0 object-fit-cover ms-2 border border-2 border-primary border-opacity-25" alt="James" width="40" height="40" x-on:error="$el.src='/assets/images/product-placeholder.svg'">
                                        <div class="flex-grow-1">
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                ...
                <div class="dropdown h-100 d-flex align-items-center">
                    <button class="btn btn-body-secondary p-1 pe-md-3 d-flex align-items-center gap-2 rounded-pill shadow-none border-0 transition-all hover-bg-secondary"
                        ...
                        <span class="d-none d-md-flex flex-column text-start ms-1 lh-1">
                            <span class="fw-bold text-body" style="font-size: 13px;"><?php echo e(Auth::user()?->name ?? 'User'); ?></span>
                            <span class="text-muted fw-semibold" style="font-size: 10px;"><?php echo e(Auth::user()?->roles->first()?->name ?? 'User'); ?></span>
                        </span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4 mt-3 py-2"
                        ...
                        <li class="px-4 py-3 d-flex align-items-center gap-3 border-bottom mb-2">
                            ...
                            <div style="min-width: 0;">
                                <h6 class="mb-1 fw-bold text-body text-truncate"><?php echo e(Auth::user()?->name ?? 'User'); ?></h6>
                                <p class="mb-0 text-muted small text-truncate"><?php echo e(Auth::user()?->email ?? 'admin@example.com'); ?></p>
                            </div>
                        </li>
...
<?php if (isset($component)) { $__componentOriginalfa0744ffc443866b92f4475b574b1854 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalfa0744ffc443866b92f4475b574b1854 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.add-customer-modal','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('add-customer-modal'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginalfa0744ffc443866b92f4475b574b1854)): ?>
<?php $attributes = $__attributesOriginalfa0744ffc443866b92f4475b574b1854; ?>
<?php unset($__attributesOriginalfa0744ffc443866b92f4475b574b1854); ?>
<?php endif; ?>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('headerCart', () => ({
        ...
        checkoutHref() {
            ...
            return '<?php echo e(route('orders.create')); ?>';
        },
        removeItem(index) {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/user/metis/resources/views/components/header.blade.php ENDPATH**/ ?>