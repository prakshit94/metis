...
<div class="warehouses-management" x-data="warehousesTable" x-cloak>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 mb-lg-5">
        <div>
            ...
            <p class="text-muted mb-0">Manage your catalog warehouses</p>
        </div>
            ...
            <div class="card stats-card h-100">
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <p class="h6 mb-0 text-muted">Active Warehouses</p>
            ...
            <div class="card stats-card h-100">
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <p class="h6 mb-0 text-muted">Inactive Warehouses</p>
    ...
    <!-- Form Modal -->
    <div class="modal fade" id="warehousesModal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header border-bottom-0 pb-0">
                    <h5 class="modal-title fw-bold" x-text="isEditing ? 'Edit Warehouse' : 'Add Warehouse'"></h5>
                        ...
                        <div class="card border-0 shadow-sm mb-4 bg-body-tertiary">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <h6 class="card-title mb-0 fw-bold">Warehouse Details</h6>
                                </div>
                                
                                <div class="row g-3">
                                    <div class="col-12">
                                        <label class="form-label fw-medium text-muted small">Name / Code <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" x-model="form.name" required placeholder="e.g. Main Warehouse, Berlin-01">
                                        <div class="form-text text-muted" style="font-size: 0.75rem;">Primary identifier for this warehouse.</div>
                                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ubuntu/metis/resources/views/catalog/warehouses/index.blade.php ENDPATH**/ ?>