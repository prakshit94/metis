...
<body>
    ...
    <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="receipt-container <?php echo e(!$loop->last ? 'page-break' : ''); ?>">
            <div class="label-container">
                ...
                <div class="box">
                    ...
                    <?php if($address): ?>
                        ...
                        <strong>State:</strong> <?php echo e($address->state); ?> -
                        <?php echo e($address->pincode); ?><br>
                    <?php else: ?>
...
<?php /**PATH /home/ubuntu/metis/resources/views/orders/pdf/bulk_cod.blade.php ENDPATH**/ ?>