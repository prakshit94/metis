...
<div class="user-management" x-data="rolesPermissionsTable">
    <div class="d-flex justify-content-between align-items-center mb-4 mb-lg-5 mb-xl-6">
        ...
        <div class="d-flex gap-2">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['role-import', 'permission-import'])): ?>
            <button type="button" class="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#accessImportModal">
                <i class="bi bi-upload me-2"></i>Import
            </button>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['role-export', 'permission-export'])): ?>
            <button type="button" class="btn btn-outline-secondary" @click="exportItems()">
                <i class="bi bi-download me-2"></i>Export
            </button>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['role-create', 'permission-create'])): ?>
        ...
        <div class="card-body p-0">
            <div class="bulk-actions-bar p-3 bg-primary bg-opacity-10 border-bottom border-primary border-opacity-25" x-show="selectedItems.length > 0">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['role-delete', 'permission-delete'])): ?>
                        <button class="btn btn-sm btn-danger" @click="bulkAction('delete')" x-show="hasSelectedActiveItems">
                            <i class="bi bi-trash me-1"></i>Delete
                        </button>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['role-restore', 'permission-restore'])): ?>
                        <button class="btn btn-sm btn-success" @click="bulkAction('restore')" x-show="hasSelectedDeletedItems">
                            <i class="bi bi-arrow-counterclockwise me-1"></i>Restore
                        </button>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['role-permanent-delete', 'permission-permanent-delete'])): ?>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['role-edit', 'permission-edit'])): ?>
                                            <li>
    ...
    <div class="modal-dialog modal-fullscreen modal-dialog-scrollable" x-data="accessForm">
        <form class="modal-content" @submit.prevent="saveItem()">
                ...
                <div class="modal-footer">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['role-create', 'role-edit', 'permission-create', 'permission-edit'])): ?>
