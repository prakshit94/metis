<?php $__env->startSection('title', 'Manage Call Tags'); ?>
                ...
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="h3 mb-0 fw-bold"><?php echo e($stats['total'] ?? 0); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="h3 mb-0 fw-bold"><?php echo e($stats['active'] ?? 0); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="h3 mb-0 fw-bold"><?php echo e($stats['level_1'] ?? 0); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="h3 mb-0 fw-bold"><?php echo e($stats['inactive'] ?? 0); ?></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card-body p-0">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            
                            <tr class="bg-body-tertiary" x-show="isVisible('<?php echo e(addslashes($l1->name)); ?>', <?php echo e($l1->is_active); ?>)" :class="{ 'bg-primary bg-opacity-10': selected.includes(<?php echo e($l1->id); ?>) }">
                                <td class="ps-4">
                                    <div class="d-flex align-items-center">
                                        <input type="checkbox" class="form-check-input shadow-sm border-secondary border-opacity-25 me-3" value="<?php echo e($l1->id); ?>" x-model.number="selected">
                                        <i class="bi bi-folder-fill text-warning me-2 fs-5"></i>
                                        <span class="fw-bold"><?php echo e($l1->name); ?></span>
                                    </div>
                                </td>
                                ...
                                <td class="text-end pe-4">
                                    <button class="btn btn-sm btn-light border shadow-sm me-1 rounded-circle transition-all hover-shadow" style="width: 32px; height: 32px; padding: 0;" @click="openModal(<?php echo e($l1->id); ?>, '<?php echo e(addslashes($l1->name)); ?>', 1, null, <?php echo e($l1->is_active); ?>)" title="Edit">
                                        <i class="bi bi-pencil text-secondary"></i>
                                    </button>
                                    <button class="btn btn-sm btn-outline-primary shadow-sm me-1 rounded-pill fw-bold px-3 transition-all hover-shadow" style="font-size: 11px; letter-spacing: 0.5px;" @click="openModal(null, '', 2, <?php echo e($l1->id); ?>, 1)" title="Add L2 Tag">
                                        <i class="bi bi-plus-lg me-1"></i> ADD L2
                                    </button>
                                    <button class="btn btn-sm btn-light text-danger border shadow-sm rounded-circle transition-all hover-shadow" style="width: 32px; height: 32px; padding: 0;" @click="deleteTag(<?php echo e($l1->id); ?>)" title="Delete">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                </td>
                            </tr>
                            
                            <?php $__currentLoopData = $l1->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                
                                <tr x-show="isVisible('<?php echo e(addslashes($l2->name)); ?>', <?php echo e($l2->is_active); ?>)" :class="{ 'bg-primary bg-opacity-10': selected.includes(<?php echo e($l2->id); ?>) }">
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center ms-4">
                                            <input type="checkbox" class="form-check-input shadow-sm border-secondary border-opacity-25 me-3" value="<?php echo e($l2->id); ?>" x-model.number="selected">
                                            <i class="bi bi-arrow-return-right text-muted me-2"></i>
                                            <i class="bi bi-folder2-open text-info me-2 fs-5"></i>
                                            <span class="fw-semibold text-body-emphasis"><?php echo e($l2->name); ?></span>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <?php if($l2->formFields->count() > 0): ?>
                                            <span class="badge bg-primary rounded-pill"><?php echo e($l2->formFields->count()); ?> Fields</span>
                                        <?php else: ?>
                                            <span class="text-muted small">-</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-end pe-4">
                                        <button class="btn btn-sm btn-light border shadow-sm me-1 rounded-circle transition-all hover-shadow" style="width: 32px; height: 32px; padding: 0;" @click="openModal(<?php echo e($l2->id); ?>, '<?php echo e(addslashes($l2->name)); ?>', 2, <?php echo e($l2->parent_id); ?>, <?php echo e($l2->is_active); ?>, <?php echo e(json_encode($l2->formFields)); ?>)" title="Edit">
                                            <i class="bi bi-pencil text-secondary"></i>
                                        </button>
                                        <button class="btn btn-sm btn-outline-info shadow-sm me-1 rounded-pill fw-bold px-3 transition-all hover-shadow" style="font-size: 11px; letter-spacing: 0.5px;" @click="openModal(null, '', 3, <?php echo e($l2->id); ?>, 1)" title="Add L3 Tag">
                                            <i class="bi bi-plus-lg me-1"></i> ADD L3
                                        </button>
                                        <button class="btn btn-sm btn-light text-danger border shadow-sm rounded-circle transition-all hover-shadow" style="width: 32px; height: 32px; padding: 0;" @click="deleteTag(<?php echo e($l2->id); ?>)" title="Delete">
                                            <i class="bi bi-trash"></i>
                                        </button>
                                    </td>
                                </tr>
                                
                                <?php $__currentLoopData = $l2->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l3): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    
                                    <tr x-show="isVisible('<?php echo e(addslashes($l3->name)); ?>', <?php echo e($l3->is_active); ?>)" :class="{ 'bg-primary bg-opacity-10': selected.includes(<?php echo e($l3->id); ?>) }">
                                        <td class="ps-4">
                                            <div class="d-flex align-items-center ms-5" style="padding-left: 2rem;">
                                                <input type="checkbox" class="form-check-input shadow-sm border-secondary border-opacity-25 me-3" value="<?php echo e($l3->id); ?>" x-model.number="selected">
                                                <i class="bi bi-arrow-return-right text-muted me-2"></i>
                                                <i class="bi bi-tag text-success me-2"></i>
                                                <span class="text-secondary"><?php echo e($l3->name); ?></span>
                                            </div>
                                        </td>
                                        ...
                                        <td>-</td>
                                        <td class="text-end pe-4">
                                            <button class="btn btn-sm btn-light border shadow-sm me-1 rounded-circle transition-all hover-shadow" style="width: 32px; height: 32px; padding: 0;" @click="openModal(<?php echo e($l3->id); ?>, '<?php echo e(addslashes($l3->name)); ?>', 3, <?php echo e($l3->parent_id); ?>, <?php echo e($l3->is_active); ?>)" title="Edit">
                                                <i class="bi bi-pencil text-secondary"></i>
                                            </button>
                                            <button class="btn btn-sm btn-light text-danger border shadow-sm rounded-circle transition-all hover-shadow" style="width: 32px; height: 32px; padding: 0;" @click="deleteTag(<?php echo e($l3->id); ?>)" title="Delete">
                                                <i class="bi bi-trash"></i>
                                            </button>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/user/metis/resources/views/call-tags/index.blade.php ENDPATH**/ ?>