...
function createOrderApp(initialCustomer = null, initialOrder = null) {
    return {
        ...
        partyId: new URLSearchParams(window.location.search).get('customer_id') || '', warehouseId: '<?php echo e($warehouses->first()->id ?? ''); ?>', shippingAddressId: '', billingAddressId: '', sameAsShipping: true, orderType: 'sale', shippingFee: 0,
