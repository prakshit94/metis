...
<?php $__env->startSection('content'); ?>
    ...
    <div x-data="createOrderApp(window.__INITIAL_ORDER_CUSTOMER__, window.__INITIAL_ORDER_TO_EDIT__)"
         @call-log-added.window="if(customerDetails) { isCallLoggedOrClosed = true; window.location.href = '<?php echo e(route('dashboard')); ?>'; }">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 mb-lg-5 mb-xl-6">
        ...
        <div class="d-flex gap-2">
            <template x-if="editingOrderId || isConfirmMode">
                <a href="<?php echo e(route('orders')); ?>" data-bypass="true" class="btn btn-outline-danger shadow-sm" @click="isCallLoggedOrClosed = true">
                    <i class="bi bi-x-circle me-1"></i> <span x-text="isConfirmMode ? 'Cancel Confirmation' : 'Cancel Edit Mode'"></span>
                </a>
            </template>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('skip-call-log')): ?>
            <button type="button" class="btn btn-outline-danger shadow-sm" x-show="customerDetails" @click="isCallLoggedOrClosed = true; window.location.href = '<?php echo e(route('dashboard')); ?>'" title="Bypass Call Logging">
                ...
                <div class="card-body p-4 p-lg-4" x-show="showCustomerWorkspace">
                    ...
                    <div id="addresses-section" x-show="partyId" x-cloak class="mt-4 pt-4 border-top transition-all">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customeraddress-create')): ?>
                                            ...
                                            <div class="card h-100 border shadow-sm transition-all" :class="shippingAddressId == addr.id ? 'border-primary bg-primary bg-opacity-10' : 'bg-body'">
                                                <div class="card-body p-3 position-relative">
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        ...
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customeraddress-edit')): ?>
...
function createOrderApp(initialCustomer = null, initialOrder = null) {
    return {
        ...
        cancelReason: '',
        cancelNotes: '',
        cancelReasons: <?php echo json_encode($cancelReasons ?? [], 15, 512) ?>,
...
<?php endif; ?>
<?php if (isset($component)) { $__componentOriginalaa927f2158585bc4a89c156e4c5c1d91 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalaa927f2158585bc4a89c156e4c5c1d91 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.call-tagging-modal','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('call-tagging-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalaa927f2158585bc4a89c156e4c5c1d91)): ?>
<?php $attributes = $__attributesOriginalaa927f2158585bc4a89c156e4c5c1d91; ?>
<?php unset($__attributesOriginalaa927f2158585bc4a89c156e4c5c1d91); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalaa927f2158585bc4a89c156e4c5c1d91)): ?>
<?php $component = $__componentOriginalaa927f2158585bc4a89c156e4c5c1d91; ?>
<?php unset($__componentOriginalaa927f2158585bc4a89c156e4c5c1d91); ?>
<?php endif; ?>
