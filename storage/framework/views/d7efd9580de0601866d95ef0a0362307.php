...
<div class="village-management" x-data="villageTable" x-init="init()">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 mb-lg-5 mb-xl-6">
        ...
        <div class="d-flex gap-2">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('village-export')): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/user/metis/resources/views/villages/index.blade.php ENDPATH**/ ?>