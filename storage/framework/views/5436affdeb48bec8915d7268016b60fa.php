<?php $__env->startSection('title', '⭐ Referral Programs'); ?>
<?php $__env->startSection('page', 'referrals.programs.index'); ?>
        ...
        <div class="alert alert-danger alert-dismissible fade show shadow-sm border-0 rounded-4" role="alert">
            <ul class="mb-0">
                <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><i class="bi bi-exclamation-triangle-fill me-2"></i> <?php echo e($error); ?></li>
                ...
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="h3 mb-0 fw-bold"><?php echo e($programs->count()); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="h3 mb-0 fw-bold"><?php echo e($programs->where('is_active', true)->count()); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="h3 mb-0 fw-bold"><?php echo e($programs->whereNull('start_date')->count()); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="h3 mb-0 fw-bold"><?php echo e($programs->whereNotNull('start_date')->count()); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td class="ps-4">
                                    <input type="checkbox" class="form-check-input" value="<?php echo e($program->id); ?>" x-model="selected">
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <div class="fw-bold text-body-emphasis"><?php echo e($program->name); ?></div>
                                            <div class="text-muted small" style="font-size: 10px;">ID: #<?php echo e($program->id); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex flex-column gap-1">
                                        ...
                                        <?php else: ?>
                                            <div class="small" style="font-size: 11px;">
                                                <div class="text-nowrap text-muted"><span class="fw-semibold text-body-emphasis">From:</span> <?php echo e($program->start_date ? $program->start_date->format('M d, Y') : '∞'); ?></div>
                                                <div class="text-nowrap text-muted"><span class="fw-semibold text-body-emphasis">To:</span> <?php echo e($program->end_date ? $program->end_date->format('M d, Y') : '∞'); ?></div>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                <td>
                                    <form action="<?php echo e(route('referrals.programs.toggle', $program->id)); ?>" method="POST" class="d-inline m-0 p-0">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PATCH'); ?>
                                        <span class="badge rounded-pill px-3 py-2 fw-medium border cursor-pointer custom-hover-opacity <?php echo e($program->is_active ? 'bg-success-subtle text-success-emphasis border-success-subtle' : 'bg-secondary-subtle text-secondary-emphasis border-secondary-subtle'); ?>" onclick="this.closest('form').submit()" title="Click to toggle status">
                                            <span class="d-inline-block rounded-circle me-1 <?php echo e($program->is_active ? 'bg-success' : 'bg-secondary'); ?>" style="width: 6px; height: 6px; vertical-align: middle;"></span>
                                ...
                                <td>
                                    <div class="d-flex flex-wrap gap-1">
                                        <?php $__currentLoopData = $program->milestones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="badge bg-body-tertiary text-body-emphasis border px-2 py-1 d-inline-flex align-items-center gap-1">
                                                <?php if($milestone->reward_type === 'wallet'): ?>
                                                    <i class="bi bi-wallet2 text-primary"></i>
                                                <?php elseif($milestone->reward_type === 'coupon'): ?>
                                                    <i class="bi bi-tag-fill text-warning"></i>
                                                <?php else: ?>
                                                    <i class="bi bi-box2-heart-fill text-success"></i>
                                                <?php endif; ?>
                                                <span><?php echo e($milestone->required_referrals == 0 ? 'Every Ref' : $milestone->required_referrals . ' Refs'); ?> = <?php echo e(ucfirst($milestone->reward_type)); ?>: <?php echo e($milestone->reward_value); ?></span>
                                            </span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </td>
                                <td class="text-end pe-4">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                                            <li>
                                                <a class="dropdown-item" href="#" @click.prevent="editProgram(<?php echo e($program->toJson()); ?>)">
                                                    <i class="bi bi-pencil me-2"></i>Edit
                                                </a>
                                            </li>
                                            <li><hr class="dropdown-divider"></li>
                                            <li>
                                                <form action="<?php echo e(route('referrals.programs.destroy', $program->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="createProgramModal" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content border-0 shadow-lg rounded-4 bg-body">
                ...
                <form :action="form.id ? `<?php echo e(url('/promotions/referral-programs')); ?>/${form.id}` : `<?php echo e(route('referrals.programs.store')); ?>`" method="POST">
                    <?php echo csrf_field(); ?>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('referralPrograms', () => ({
            programs: <?php echo json_encode($programs->pluck('id'), 15, 512) ?>,
            allProducts: <?php echo json_encode($products ?? [], 15, 512) ?>,
            selected: [],
            get allSelected() { 
            ...
            async bulkAction(action) {
                ...
                try {
                    const res = await fetch('<?php echo e(route('referrals.programs.bulk')); ?>', { 
                        method: 'POST', 
                        headers: { 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/user/metis/resources/views/promotions/referrals/index.blade.php ENDPATH**/ ?>