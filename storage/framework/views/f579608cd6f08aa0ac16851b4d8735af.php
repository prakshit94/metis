        ...
        <div class="row align-items-center g-4">
            ...
            <div class="col-lg-3 col-md-12 border-end border-secondary-subtle pe-lg-4 mb-4 mb-lg-0 pb-4 pb-lg-0">
                <h3 class="h5 fw-bold mb-3 d-flex align-items-center text-body-emphasis">
                    <i class="bi bi-buildings text-primary me-2 fs-5"></i><?php echo e($selectedWarehouseName); ?>
                ...
                <div class="p-3 bg-light bg-opacity-50 rounded-4 border border-secondary-subtle mb-3 shadow-sm">
                    ...
                    <span class="fs-4 fw-bold text-success">₹<?php echo e(number_format($totalValue, 2)); ?></span>
                </div>
                
                <div class="px-1">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="small text-muted fw-bold text-uppercase tracking-wide" style="font-size: 0.7rem;">Delivery Rate</span>
                        <span class="small fw-bold text-success"><?php echo e($deliveryRate); ?>%</span>
                    </div>
                    <div class="progress rounded-pill bg-success bg-opacity-10" style="height: 6px;">
                        <div class="progress-bar bg-success rounded-pill" role="progressbar" style="width: <?php echo e($deliveryRate); ?>%"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-9 col-md-12 ps-lg-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <?php if($pipeline['returns_requested']['count'] > 0): ?>
                    <div class="badge bg-danger bg-opacity-10 border border-danger border-opacity-25 text-danger-emphasis py-1 px-3 rounded-pill d-flex align-items-center gap-2">
                        ...
                        <span><?php echo e($pipeline['returns_requested']['count']); ?> Return(s) Req (₹<?php echo e(number_format($pipeline['returns_requested']['amount'])); ?>)</span>
                    </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="d-flex align-items-stretch flex-nowrap overflow-x-auto pb-2 gap-2" style="scrollbar-width: thin;">
                    ...
                    <div class="flex-fill p-3 rounded-4 bg-warning bg-opacity-10 border border-warning border-opacity-25 d-flex flex-column text-center position-relative transition-hover" style="min-width: 130px;">
                        ...
                        <span class="fw-bold fs-4 text-warning-emphasis lh-1 mb-1"><?php echo e($pipeline['pending']['count']); ?></span>
                        <small class="text-warning-emphasis opacity-75 fw-medium" style="font-size: 0.75rem;">₹<?php echo e(number_format($pipeline['pending']['amount'])); ?></small>
                    ...
                    <div class="flex-fill p-3 rounded-4 bg-info bg-opacity-10 border border-info border-opacity-25 d-flex flex-column text-center position-relative transition-hover" style="min-width: 130px;">
                        ...
                        <span class="fw-bold fs-4 text-info-emphasis lh-1 mb-1"><?php echo e($pipeline['confirmed']['count']); ?></span>
                        <small class="text-info-emphasis opacity-75 fw-medium" style="font-size: 0.75rem;">₹<?php echo e(number_format($pipeline['confirmed']['amount'])); ?></small>
                    ...
                    <div class="flex-fill p-3 rounded-4 bg-primary bg-opacity-10 border border-primary border-opacity-25 d-flex flex-column text-center position-relative transition-hover" style="min-width: 130px;">
                        ...
                        <span class="fw-bold fs-4 text-primary-emphasis lh-1 mb-1"><?php echo e($pipeline['processing']['count']); ?></span>
                        <small class="text-primary-emphasis opacity-75 fw-medium" style="font-size: 0.75rem;">₹<?php echo e(number_format($pipeline['processing']['amount'])); ?></small>
                    ...
                    <div class="flex-fill p-3 rounded-4 bg-warning-subtle bg-opacity-50 border border-warning border-opacity-25 d-flex flex-column text-center position-relative transition-hover" style="min-width: 130px;">
                        ...
                        <span class="fw-bold fs-4 text-warning-emphasis lh-1 mb-1"><?php echo e($pipeline['ready_to_ship']['count']); ?></span>
                        <small class="text-warning-emphasis opacity-75 fw-medium" style="font-size: 0.75rem;">₹<?php echo e(number_format($pipeline['ready_to_ship']['amount'])); ?></small>
                        <i class="bi bi-caret-right-fill position-absolute top-50 start-100 translate-middle text-warning opacity-50 d-none d-sm-block" style="font-size: 1.5rem; transform: translate(-50%, -50%) !important; z-index: 2;"></i>
                    </div>
                    ...
                    <div class="flex-fill p-3 rounded-4 bg-secondary bg-opacity-10 border border-secondary border-opacity-25 d-flex flex-column text-center position-relative transition-hover" style="min-width: 130px;">
                        ...
                        <span class="fw-bold fs-4 text-secondary-emphasis lh-1 mb-1"><?php echo e($pipeline['dispatched']['count']); ?></span>
                        <small class="text-secondary-emphasis opacity-75 fw-medium" style="font-size: 0.75rem;">₹<?php echo e(number_format($pipeline['dispatched']['amount'])); ?></small>
                    ...
                    <div class="flex-fill p-3 rounded-4 bg-success bg-opacity-10 border border-success border-opacity-25 d-flex flex-column text-center transition-hover" style="min-width: 130px;">
                        ...
                        <span class="fw-bold fs-4 text-success-emphasis lh-1 mb-1"><?php echo e($pipeline['delivered']['count']); ?></span>
                        <small class="text-success-emphasis opacity-75 fw-medium" style="font-size: 0.75rem;">₹<?php echo e(number_format($pipeline['delivered']['amount'])); ?></small>
                    </div>
                </div>
                ...
                <div class="d-flex gap-4 mt-4 ps-1">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="small text-secondary-emphasis fw-medium">Returned: <span><?php echo e($pipeline['returned']['count']); ?></span> (₹<?php echo e(number_format($pipeline['returned']['amount'])); ?>)</span>
                    </div>
                    
                    <div class="d-flex align-items-center gap-2">
                        <div class="bg-dark rounded-circle" style="width: 8px; height: 8px;"></div>
                        <span class="small text-dark-emphasis fw-medium">Cancelled: <span><?php echo e($pipeline['cancelled']['count']); ?></span> (₹<?php echo e(number_format($pipeline['cancelled']['amount'])); ?>)</span>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH /home/user/metis/resources/views/inventory/dashboard/partials/pipeline.blade.php ENDPATH**/ ?>