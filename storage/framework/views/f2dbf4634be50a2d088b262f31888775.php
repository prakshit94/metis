...
?>
<tbody <?php echo e($attributes->except('class')->merge(['class' => '[&_tr:last-child]:border-0 ' . $extraClass])); ?>>
    <?php echo e($slot); ?>

</tbody>
<?php /**PATH /home/ubuntu/metis/resources/views/components/ui/table-body.blade.php ENDPATH**/ ?>