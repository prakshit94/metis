...
<?php $__env->startSection('page', 'catalog-brands'); ?>

<?php $__env->startSection('content'); ?>
<div class="brands-management" x-data="brandsTable" x-cloak>
    <!-- Page Header -->
    <div class="d-flex justify-content-between align-items-center mb-4 mb-lg-5">
        <div>
            <h1 class="h3 mb-0">Brands Management</h1>
            <p class="text-muted mb-0">Manage your catalog brands</p>
        </div>
            ...
            <div class="card stats-card h-100">
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <p class="h6 mb-0 text-muted">Total Brands</p>
            ...
            <div class="card stats-card h-100">
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <p class="h6 mb-0 text-muted">Active Brands</p>
            ...
            <div class="card stats-card h-100">
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <p class="h6 mb-0 text-muted">Inactive Brands</p>
    ...
    <div class="card">
        <div class="card-header">
            <div class="row align-items-center">
                <div class="col">
                    <h2 class="h5 card-title mb-0">Brands Directory</h2>
                </div>
                <div class="col-auto">
                    <div class="d-flex gap-2">
                        <!-- Search -->
                    ...
                    <form @submit.prevent="saveItem">
                        ...
                        <div class="card border-0 shadow-sm mb-4 bg-body-tertiary">
                            <div class="card-body p-4">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <h6 class="card-title mb-0 fw-bold">Brand Information</h6>
                                </div>
                                
                                <div class="row g-3">
                                    <div class="col-12">
                                        <label class="form-label fw-medium text-muted small">Name / Code <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" x-model="form.name" required placeholder="e.g. Nike, Samsung">
                                        <div class="form-text text-muted" style="font-size: 0.75rem;">Primary identifier for this brand.</div>
                                    </div>
                        ...
                        <div class="modal-footer border-top-0 pt-0 px-0">
                            ...
                            <button type="submit" class="btn btn-primary px-4" :disabled="saving">
                                ...
                                <span x-text="isEditing ? 'Update Brand' : 'Save Brand'"></span>
                            </button>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ubuntu/metis/resources/views/catalog/brands/index.blade.php ENDPATH**/ ?>