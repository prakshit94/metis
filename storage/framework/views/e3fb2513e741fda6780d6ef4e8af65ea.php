...
document.addEventListener('alpine:init', () => {
    Alpine.data('addCustomerApp', () => ({
        phone: '',
        sources: <?php echo json_encode($dynamicLeadSources ?? ['Referral', 'Walk-in', 'Social Media', 'Website', 'Advertisement', 'Event', 'Cold Call', 'Other']); ?>,
        selectedSources: [],
        showSourceDropdown: false,
        landUnits: <?php echo json_encode($dynamicLandUnits ?? ['Acre', 'Hectare', 'Bigha', 'Guntha', 'Kanal', 'Marla']); ?>,
        irrigationTypes: <?php echo json_encode($dynamicIrrigationTypes ?? ['Drip', 'Sprinkler', 'Canal', 'Tube Well', 'Rainfed', 'River Pump']); ?>,
        selectedIrrigation: [],
        showIrrigationDropdown: false,
        allCrops: <?php echo json_encode($dynamicCrops ?? ['Wheat', 'Rice', 'Cotton', 'Sugarcane', 'Maize', 'Soybean', 'Gram', 'Mustard', 'Bajra', 'Jowar']); ?>,
        selectedCrops: [],
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/user/metis/resources/views/components/add-customer-modal.blade.php ENDPATH**/ ?>