...
<?php $component->withAttributes(['id' => 'edit-profile-modal','maxWidth' => '5xl']); ?>
    <div class="p-0 overflow-hidden" x-data="{
        ...
        sources: <?php echo e(json_encode(isset($leadSources) ? $leadSources->map(fn($s) => $s->name) : ['Referral', 'Walk-in', 'Social Media', 'Website', 'Advertisement', 'Event', 'Cold Call', 'Other'])); ?>,
        toggleSource(name) {
...
<?php endif; ?>
                        ...
                        <div class="space-y-2 group">
                            ...
                            <input type="text" name="relative_name" value="<?php echo e($customer->relative_name); ?>" class="w-full px-5 py-3 rounded-2xl bg-background/40 border border-border/60 focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all text-sm font-medium">
                        </div>
                        <div class="space-y-2 group">
