...
<?php $__env->startSection('page', 'procurement-purchase-orders'); ?>
                ...
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="h3 mb-0" aria-live="polite"><span><?php echo e($stats['total']); ?></span></div>
                ...
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="h3 mb-0" aria-live="polite"><span><?php echo e($stats['pending']); ?></span></div>
                ...
                <div class="card-body p-3 p-lg-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="h3 mb-0" aria-live="polite"><span><?php echo e($stats['completed']); ?></span></div>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('purchaseOrdersTable', () => ({
        ...
        suppliersList: <?php echo $suppliers->map(function($s) { return ['id' => $s->id, 'name' => $s->company_name ?: $s->firstname]; })->toJson(); ?>,
        warehousesList: <?php echo $warehouses->toJson(); ?>,
        productsList: <?php echo $products->map(function($p) { return ['id' => $p->id, 'name' => $p->name, 'sku' => $p->sku, 'image' => $p->image_url]; })->toJson(); ?>,
        ...
        async submitCreateForm() {
            ...
            try {
                const response = await fetch('<?php echo e(route("procurement.purchase-orders.store")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/user/metis/resources/views/procurement/purchase-orders/index.blade.php ENDPATH**/ ?>