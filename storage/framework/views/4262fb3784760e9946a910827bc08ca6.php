        ...
        <div class="card h-100 border-0 bg-primary bg-opacity-10 shadow-sm rounded-4 metric-card p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <div class="h3 mb-0 fw-bold text-body-emphasis"><?php echo e(number_format($kpis['pending_orders'])); ?></div>
                    <small class="text-muted fw-semibold">of <?php echo e(number_format($kpis['total_orders'])); ?> total</small>
                </div>
        ...
        <div class="card h-100 border-0 bg-warning bg-opacity-10 shadow-sm rounded-4 metric-card p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <div class="h3 mb-0 fw-bold text-body-emphasis"><?php echo e(number_format($kpis['pending_transfers'])); ?></div>
        ...
        <div class="card h-100 border-0 bg-danger bg-opacity-10 shadow-sm rounded-4 metric-card p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <div class="h3 mb-0 fw-bold text-body-emphasis"><?php echo e(number_format($kpis['pending_returns'])); ?></div>
        ...
        <div class="card h-100 border-0 bg-info bg-opacity-10 shadow-sm rounded-4 metric-card p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <div class="h3 mb-0 fw-bold text-body-emphasis"><?php echo e(number_format($kpis['low_stock_items'])); ?></div>
        ...
        <div class="card h-100 border-0 bg-secondary bg-opacity-10 shadow-sm rounded-4 metric-card p-3">
            <div class="d-flex align-items-center justify-content-between">
                <div>
                    ...
                    <div class="h3 mb-0 fw-bold text-body-emphasis"><?php echo e(number_format($kpis['pending_purchase_orders'])); ?></div>
...
<?php /**PATH /home/user/metis/resources/views/inventory/dashboard/partials/kpi-widgets.blade.php ENDPATH**/ ?>