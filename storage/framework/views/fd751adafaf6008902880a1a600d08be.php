<?php $__env->startSection('title', '🧾 Credit Notes Management'); ?>
<?php $__env->startSection('page', 'orders-credit-notes'); ?>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('creditNotesTable', () => ({
        ...
        total: 0, from: 0, to: 0,
        selected: [],
        stats: <?php echo json_encode($stats ?? ['total' => 0, 'active' => 0, 'used' => 0, 'cancelled' => 0]); ?>,
        customers: <?php echo isset($customers) ? $customers->map(function($c) { return ['id' => $c->id, 'name' => $c->company_name ?: $c->firstname . ' ' . $c->lastname]; })->toJson() : '[]'; ?>,
        invoices: <?php echo json_encode($invoices ?? []); ?>,
        returns: <?php echo json_encode($returns ?? []); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/user/metis/resources/views/orders/credit-notes/index.blade.php ENDPATH**/ ?>