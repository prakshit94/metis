                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" x-model="form.category_id" required>
                                    ...
                                    <template x-for="category in $store.productTable.options.categories" :key="category.id">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" x-model="form.brand_id">
                                    ...
                                    <template x-for="brand in $store.productTable.options.brands" :key="brand.id">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" x-model="form.uom_id">
                                    ...
                                    <template x-for="uom in $store.productTable.options.uoms" :key="uom.id">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" x-model="form.tax_rate_id">
                                    ...
                                    <template x-for="rate in $store.productTable.options.taxRates" :key="rate.id">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" x-model="form.hsn_code_id">
                                    ...
                                    <template x-for="hsn in $store.productTable.options.hsnCodes" :key="hsn.id">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" x-model="form.default_warehouse_id">
                                    ...
                                    <template x-for="warehouse in $store.productTable.options.warehouses" :key="warehouse.id">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" x-model="form.status" required>
                                    ...
                                    <template x-for="status in $store.productTable.options.statusList" :key="status.value">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="border rounded p-3">
                                    <template x-for="attribute in $store.productTable.options.attributes" :key="attribute.id">
                                        <div class="mb-3">
...
<div class="modal fade" id="productViewModal" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content" x-data="{ get product() { return $store.productTable.previewProduct } }">
                <div class="modal-header">
...
<div class="modal fade" id="importModal" tabindex="-1" x-data="{}">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-primary" @click="$store.productTable.importProducts()" :disabled="$store.productTable.importing">
                        <span class="spinner-border spinner-border-sm me-1" x-show="$store.productTable.importing"></span>
                        Import Products
                    </button>
                </div>
            </div>
