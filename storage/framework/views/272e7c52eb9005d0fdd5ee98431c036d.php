    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-4 pb-3 border-bottom">
        ...
        <div x-show="activeTab === 'dashboard'" x-transition.opacity.duration.300ms class="d-flex align-items-center gap-2">
            ...
            <select class="form-select form-select-sm fw-semibold shadow-sm border-0 bg-body-tertiary rounded-pill px-3" style="min-width: 140px; cursor: pointer;" onchange="window.location.href = '?filter=' + this.value">
                ...
                <option value="prev_month" <?php echo e(($filter ?? 'today') === 'prev_month' ? 'selected' : ''); ?>>Previous Month</option>
            </select>
                            ...
                            <div class="card-body p-3 p-lg-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="badge bg-info bg-opacity-25 text-info-emphasis border border-info border-opacity-50" style="font-size: 9px;"><?php echo e($orderStatusPercent['pending'] ?? 0); ?>%</span>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="badge bg-info bg-opacity-25 text-info-emphasis border border-info border-opacity-50" style="font-size: 9px;"><?php echo e($orderStatusPercent['confirmed'] ?? 0); ?>%</span>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="badge bg-info bg-opacity-25 text-info-emphasis border border-info border-opacity-50" style="font-size: 9px;"><?php echo e($orderStatusPercent['processing'] ?? 0); ?>%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-3 p-lg-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="badge bg-primary bg-opacity-25 text-primary-emphasis border border-primary border-opacity-50" style="font-size: 9px;"><?php echo e($orderStatusPercent['ready_to_ship'] ?? 0); ?>%</span>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="badge bg-primary bg-opacity-25 text-primary-emphasis border border-primary border-opacity-50" style="font-size: 9px;"><?php echo e($orderStatusPercent['dispatched'] ?? 0); ?>%</span>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="badge bg-primary bg-opacity-25 text-primary-emphasis border border-primary border-opacity-50" style="font-size: 9px;"><?php echo e($orderStatusPercent['shipped'] ?? 0); ?>%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body p-3 p-lg-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="badge bg-success bg-opacity-25 text-success-emphasis border border-success border-opacity-50" style="font-size: 9px;"><?php echo e($orderStatusPercent['completed'] ?? 0); ?>%</span>
                                    </div>
                                </div>
                            ...
                            <div class="card-body p-3 p-lg-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="badge bg-danger bg-opacity-25 text-danger-emphasis border border-danger border-opacity-50" style="font-size: 9px;"><?php echo e($orderStatusPercent['cancelled'] ?? 0); ?>%</span>
                                    </div>
                                </div>
...
<?php if(request()->has('profile_closed')): ?>
<script>
