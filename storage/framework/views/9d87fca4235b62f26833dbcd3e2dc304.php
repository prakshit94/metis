<header class="admin-header">
            <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('dashboard')); ?>">
                        <img src="<?php echo e(asset('assets/images/logo.svg')); ?>" alt="Logo" height="32" class="d-inline-block align-text-top me-2">
        ...
        </header><?php /**PATH /home/ubuntu/Bootstrap-Admin-Template/resources/views/components/navbar.blade.php ENDPATH**/ ?>