...
?>
<div <?php echo e($attributes->except('class')->merge(['class' => 'flex flex-col space-y-1.5 p-6 ' . $extraClass])); ?>>
    <?php echo e($slot); ?>

</div>
<?php /**PATH /home/ubuntu/metis/resources/views/components/ui/card-header.blade.php ENDPATH**/ ?>