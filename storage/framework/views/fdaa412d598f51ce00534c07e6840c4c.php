<div class="card border-0 shadow-sm rounded-4 h-100" 
    ...
    <div class="card-body p-4">
        <div class="timeline pe-2" x-ref="activityContainer" style="max-height: 400px; overflow-y: auto; overflow-x: hidden;">
            <?php echo $__env->make('inventory.dashboard.partials.activity-feed-items', ['recentActivity' => $recentActivity], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
</div>
<?php /**PATH /home/user/metis/resources/views/inventory/dashboard/partials/activity-feed.blade.php ENDPATH**/ ?>