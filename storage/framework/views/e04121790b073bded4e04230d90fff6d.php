...
?>
<div <?php echo e($attributes->except('class')->merge(['class' => 'p-6 pt-0 ' . $extraClass])); ?>>
    <?php echo e($slot); ?>

</div>
<?php /**PATH /home/ubuntu/metis/resources/views/components/ui/card-content.blade.php ENDPATH**/ ?>